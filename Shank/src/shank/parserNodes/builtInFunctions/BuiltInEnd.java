...
public class BuiltInEnd extends FunctionNode {
	...
	public BuiltInEnd(String name)
	{
		super(name);
	}

	/**
	 * Assigns the position of the last index of an array to an IntegerDataType var
	...
	public void execute(ArrayList<InterpreterDataType> parameters) throws SyntaxErrorException
	{
		...
		arrayEndIndex = arrayInfo.getTo();
		parameters.get(1).fromString(String.valueOf(arrayEndIndex));
	}
